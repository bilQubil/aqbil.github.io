...
export default function Home() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen min-w-full mx-auto p-4 scroll-smooth bg-linear-to-b from-cyan-700 to-purple-900 w-full">
